import NearOnEthClientABI from "./abis/nearOnEthClient.json";
import Erc20ABI from "./abis/erc20.json";
import ERC20LockerFullABI from "./abis/ERC20Locker.full.json";
import ProverABI from "./abis/prover.json";
import eNEARABI from "./abis/eNEAR.json";
import EtherCustodianABI from "./abis/etherCustodian.full.json";
...
const config = {
  ropsten_development: {
    ...
    etherCustodianAbiText: EtherCustodianABI,
